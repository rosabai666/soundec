...
/* - select SDI1 input path */
static UC bIldSDI1Sel[] = {
0x00, 0x00,    /* ILD.SDI0Sel[15:0] */
0x40, 0x00     /* ILD.SDI1Sel[15:0] */
};

/* 
   - enable input level detection
   If the signal less than -60dBFS is continuously input for more than 500ms,
   the detection notice register will be set a valid values (0x16 MIDAT[7:0]=0x01).
   Others, the detection notice register will be set a invalid value (0x00).
*/
static UC bIldOn[] = {
0x00, 0x20,    /* ILD.DetLev[15:0]  */
0x5D, 0xC0,    /* ILD.DetTime[15:0] */
...
static UC bS3DOn[] = {
0x00, 0x00,    /* S3D.ThruSel[15:0] */
0x40, 0x00     /* S3D.S3DSel[15:0]  */
};
...
static UC bHXTOn[] = {
0x00, 0x00,    /* HXT.ThruSel[15:0] */
0x40, 0x00     /* HXT.HESel[15:0]   */
};
...
static UC bAcOn[] = {
0x00, 0x00,    /* AC.ThruSel[15:0] */
0x40, 0x00     /* AC.ACSel[15:0]   */
};
...
static UC b10bPEQOn[] = {
0x00, 0x00,    /* SV.ThruSel[15:0]   */
0x40, 0x00     /* SV.10bPEQSel[15:0] */
};
...
static UC bLnOn[] = {
0x40, 0x00,    /* SV.LnSel[15:0]     */
0x00, 0x00     /* SV.LnThruSel[15:0] */
};
...
/*
	detail
	 digital network : 1Way
	 
	 MonoMix[15:0]=0dB
	 HPFSel[15:0]=0dB,  HThruSel[15:0]=-‡
	 LPFSel[15:0]=-6dB, LThruSel[15:0]=-‡
*/
0x40, 0x00,    /* CF.HPFSel[15:0]   */
0x00, 0x00,    /* CF.HThruSel[15:0] */
0x00, 0x00,    /* CF.LPFSel[15:0]   */
...
/*
	detail
	 digital network : 2Way
	 
	 MonoMix[15:0]=0dB
	 HPFSel[15:0]=0dB,  HThruSel[15:0]=-‡
	 LPFSel[15:0]=-6dB, LThruSel[15:0]=-‡
*/
0x00, 0x00,    /* CF.MonoMix[15:0]  */
0x40, 0x00,    /* CF.HPFSel[15:0]   */
0x00, 0x00,    /* CF.HThruSel[15:0] */
0x40, 0x00,    /* CF.LPFSel[15:0]   */
0x00, 0x00     /* CF.LThruSel[15:0] */
};
...
static UC bBalanceCoef[][] = {
{0x40, 0x00, 0x00, 0x00},    /* LBal=0dB,   RBal=-‡   */
...
{0x00, 0x00, 0x40, 0x00}     /* LBal=-‡,   RBal=0dB   */
};
...
static UC bLmtOn[] = {
0x00, 0x00,    /* LMT.HGCThruSel[15:0] */
0x40, 0x00,    /* LMT.HGCSel[15:0]     */
0x00, 0x00,    /* LMT.LGCThruSel[15:0] */
0x40, 0x00     /* LMT.LGCSel[15:0]     */
};
...
static UC bLmtLoMixOn[] = {
0x40, 0x00     /* LMT.LoMix[15:0] */
};
...
static UC bLmtSCOn[] = {
0x00, 0x00,    /* LMT.SCThruSel[15:0] */
0x40, 0x00     /* LMT.SCSel[15:0]     */
};
...
static UC bLmtSDO1On[] = {
0x40, 0x00,    /* LMT.LSDO1Out[15:0]  */
0x40, 0x00     /* LMT.RSDO1Out[15:0]  */
};

static UC bLmtSDO1Off[] = {
0x00, 0x00,    /* LMT.LSDO1Out[15:0]  */
0x00, 0x00     /* LMT.RSDO1Out[15:0]  */
};
...
static UC b10bPeqFlat[] = {
/*
	detail
	 Band* (*=0/1/.../8/9) : Through
*/
