...
void vec_scale16x16_fast
                  ( int16_t * restrict y,
                    ...
                    int16_t s,
                    int N );
void vec_mpyf     (     float32_t * restrict y,
                    const float32_t * restrict x,
                    const float32_t * s,
                    int N);
void vec_normlizef     (     float32_t * restrict y,
                    const float32_t * restrict x,
                    float32_t s,
                    float32_t epislon,
                    int N);
void vec_mpysumf     (     float32_t * restrict y,
                    const float32_t * restrict x,
                    const float32_t * s,
                    int N);
void vec_scaleaddf     (     float32_t * restrict y,
                    const float32_t * restrict x,
                    float32_t s,
                    int N);
void vec_subscalef ( float32_t * restrict z,
              const float32_t * restrict x,
              const float32_t * restrict y,
              const float32_t s,
              int N);
