...
***********************************************************
 *
 * @file name	: user_config_2mic_bt_headphone.h
 * @author		: yen.yu
 * @version		: Vxx.xx
 * @date		: 2022-03-23
 * @brief		: config for 2mic bt headphone application
 *
***********************************************************
 * @attention
 *
...
#ifndef __USER_CONFIG_2MIC_BT_HEADPHONE_BOX__
#define __USER_CONFIG_2MIC_BT_HEADPHONE_BOX__
...
#define USB_PID								0x2829
#define USB_PRODUCT_STRING        			"Bluetooth NC Headset"
...
#define I2S3_ENABLE							1
#define I2S_TX_FIFO_LEVEL					1  /*1-16*/
#define I2S_RX_FIFO_LEVEL					1  /*1-16*/
#define I2S_SAMPLE_RATE_DETECT 				1
...
#define SUPPORT_PLAY_TONE					1
	...
	#define D_I2S_PLAY_TONE_ENABLE			0
	#define D_USB_PLAY_TONE_ENABLE			0
...
#endif  /* __USER_CONFIG_2MIC_BT_HEADPHONE_BOX__ */
