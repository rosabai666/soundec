...
***********************************************************
 *
 * @file name	: user_config_default.h
 * @author		: yen.yu
 * @version		: Vxx.xx
 * @date		: 2022-03-23
 * @brief		: config for default app
 *
***********************************************************
 * @attention
 *
...
#ifndef __USER_CONFIG_DEFAULT_H__
#define __USER_CONFIG_DEFAULT_H__
...
#define SPK_FS_16K          				1
#define SPK_FS_32K          				0
#define SPK_FS_44P1K        				1
#define SPK_FS_48K          				1
#define SPK_FS_88P2K        				1
#define SPK_FS_96K          				1
#define SPK_FS_176P4K       				1
#define SPK_FS_192K         				1
...
#define USB_MIC_CHANNEL_SEL					(AUDIO_CHANNEL_LEFT | AUDIO_CHANNEL_RIGHT | \
											AUDIO_CHANNEL_L_SURROUND | AUDIO_CHANNEL_R_SURROUND)
//*/
/* 8-ch example. should close 24BIT.
#define	USB_MIC_CHANNELS                    8
#define USB_MIC_CHANNEL_SEL					(AUDIO_CHANNEL_LEFT | AUDIO_CHANNEL_RIGHT | \
											AUDIO_CHANNEL_L_SURROUND | AUDIO_CHANNEL_R_SURROUND | \
											AUDIO_CHANNEL_L_CENTER | AUDIO_CHANNEL_R_CENTER | \
											AUDIO_CHANNEL_SIDE_L | AUDIO_CHANNEL_SIDE_R)
*/

#define MIC_FS_8K               			1
#define MIC_FS_16K              			1
#define MIC_FS_32K              			0
#define MIC_FS_44P1K            			1
#define MIC_FS_48K              			1
#define MIC_FS_88P2K            			1
#define MIC_FS_96K              			1
#define MIC_FS_176P4K           			1
#define MIC_FS_192K             			1
#define MIC_AUDIO_16BIT         			1
#define MIC_AUDIO_24BIT         			1
#endif
...
#endif
#endif
#if (SUPPORT_PLAY_TONE && !FLASH_ENABLE)
#error "The prompt tone function must read the flash !!!"
#undef SUPPORT_PLAY_TONE
#endif
...
#endif  /* __USER_CONFIG_DEFAULT_H__ */
