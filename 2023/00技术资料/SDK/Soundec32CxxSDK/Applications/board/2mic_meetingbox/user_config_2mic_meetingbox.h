...
***********************************************************
 *
 * @file name	: user_config_2mic_meetingbox.h
 * @author		: yen.yu
 * @version		: Vxx.xx
 * @date		: 2022-03-23
 * @brief		: config for 2mic meeting box application
 *
***********************************************************
 * @attention
 *
...
#ifndef __USER_CONFIG_2MIC_MEETING_BOX__
#define __USER_CONFIG_2MIC_MEETING_BOX__
 ...
 *  Module:		ALG
 ****************************************************/
#define SUPPORT_ALG_2MIC_MEETING_BOX		0
...
#define ADC3456_AIAS 						1		/*ADC3456 sample rate tuning*/
...
#define USB_PID								0x1829
#define USB_PRODUCT_STRING        			"USB Conference Phone"
...
#endif  /* __USER_CONFIG_2MIC_MEETING_BOX__ */
